...
<body>
	...
	<c:forEach items="${auctionDetailData}" var="auctionVO">
			...
			<div class="friend">
				...
				<p>
					...
					<span>나리신뢰지수 <strong><c:out
								value="${auctionVO.total_score}" /></strong> / 5
					</span>
				</p>
			</div>
			<hr class="style1">
		...
		<div class="conten">
			<h5>
				<strong>오픈카톡 주소</strong><br> <a href="${auctionVO.kakao}"><img
					src="img/ka.png" width="50px" height="50px"></a>
			</h5>
			<hr class="style2">
		</div>
		<div class="conten">
			<h5>
				<a
					href="Controller?cmd=declareAction&number=${auctionVO.auction_num}"><strong>신고하기</strong></a>
			</h5>
		</div>
		<div class="down"></div>
	</c:forEach>
