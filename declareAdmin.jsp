	...
	<div class="container-fluid" id="main">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-md-9 col-lg-10 main">
				<c:forEach items="${declareCalData}" var="studentVO">
					<div class="row mb-3">
					...
					<div class="col-10 placeholder">
						<div>
							<table>
							  ...
							  <tbody>
							  <c:forEach items="${declareData}" var="studentVO">
							    ...
							    <tr>
							      ...
							      <td>
							      	<c:choose>
							      		<c:when test="${studentVO.stu_status=='탈퇴'}">
							      		
							      		</c:when>
							      		<c:otherwise>
							      			<a href="Controller?cmd=memberFireAction&reporter_stu_num=${studentVO.reporter_stu_num}" 
												onclick="return confirm('정말로 탈퇴를 하시겠습니까?')">
