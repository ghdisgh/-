				...
				<div class="column">
					<div class="dashboard">
						<div class="dashboard__content">
							<div class="header">
								<div>
									<p class="title is-5 is-pulled-left font-color-dark">등록한 상품
									</p>
							...
							<c:forEach items="${enrollProductData}" var="enrollProductVO">
								<div class="cardee ripple">
									<c:choose>
										<c:when test="${enrollProductVO.sell_condition == '거래 중'}">
											<span class="badg badge-ing"><c:out
													value="${enrollProductVO.sell_condition}" /></span>
										</c:when>
										<c:when test="${enrollProductVO.sell_condition == '거래 완료'}">
									...
									<a
										href="Controller?cmd=myPageEnrollPurchaseAction&number=${enrollProductVO.num}">
										<input type="hidden" name="num" value="${enrollProductVO.num}">
										<img src="img/${enrollProductVO.img1}" height="170" width="170" />
									</a>
									<div class="pname">
										<c:out value="${enrollProductVO.name}" />
										<br />
										<h6 class="lead">
											<fmt:formatNumber value="${enrollProductVO.price}"
												pattern="###,###,###" />
										</h6>
									</div>
								</div>	
