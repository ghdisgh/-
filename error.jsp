				...
				<div class="sign-in-htm">
					<form id="join" name="join" onsubmit="return validate();"
						...
						<div class="form-group">
							...
							<div class="controls">
								<input type="password" id="password" class="floatLabel"
									name="pw"> <label for="password">비밀번호</label>
							</div>
						</div>
						<div class="error">
							<a href="#forgot">아이디와 비밀번호가 맞지 않습니다.<br> 다시 로그인해주세요~
							</a>
						</div>
						<input type="button" class="col-1-4" value="로그인"
							onclick="CheckForm();">
				...
				<div class="sign-up-htm">
					<form id="join2" name="join2" onsubmit="return validate();"
						...
						<div class="form-group">
							...
							<div class="controls">
								<input type="password" id="pass" class="floatLabel" name="pw"
									data-type="password"> <label for="pass">비밀번호</label>
							</div>
							<div class="controls">
							...
							<div class="controls">
								<select id="department" class="floatLabel" name="department"
									required>
							...
							<div class="controls">
								<input name="bankNumber" type="text" id="bankNumber"
									class="floatLabel"> <label for="bankNumber">계좌번호(-
									적어주세요)</label>
							</div>
						</div>
						<input type="button" class="col-1-4" value="Sign UP"
							onclick="CheckForm2();">
					</form>
				</div>
			</div>
