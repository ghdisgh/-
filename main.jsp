...
.form {
	...
	/* height: 40px; */
	z-index: 1;
	box-shadow: 0px 1px 0px 0px #cccccca8;
}
...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<a href="Controller?cmd=mainPopUpUI"> <img src="img/b4.png"
					height="150" width="300" class="d-block w-100" alt="...">
				</a>
			</div>
			<div class="carousel-item">
				<img src="img/b1.png" height="150" width="300" class="d-block w-100"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="img/b2.png" height="150" width="300" class="d-block w-100"
					alt="...">
			</div>
			<div class="carousel-item">
				<img src="img/b3.png" height="150" width="300" class="d-block w-100"
					alt="...">
			</div>
		</div>
	</div>
	...
	<div class="page main">
		<c:forEach items="${productData}" var="mainVO">
			<div class="cardee ripple">
				...
				<a href="Controller?cmd=productPurchaseAction&number=${mainVO.num}">
					<img src="img/${mainVO.img1}" height="170" width="170" />
				</a>
				<div class="pname">
		...
		<c:forEach items="${bazaarData}" var="mainVO">
			<div class="cardee ripple">
				<c:choose>
					<c:when test="${mainVO.sell_condition == '거래 중'}">
						<span class="badg badge-ing"><c:out
				...
				<a href="Controller?cmd=productPurchaseAction&number=${mainVO.num}">
					<img src="img/${mainVO.img1}" height="200" width="200" />
				</a>
				<div class="pname">
					<c:out value="${mainVO.name}" />
					<br />
		...
		<c:forEach items="${groupBuyingData}" var="mainVO">
			<div class="cardee ripple">
				<span class="badge"></span> <a
					href="Controller?cmd=groupPurchaseAction&number=${mainVO.groupBuying_num}">
					<img src="img/${mainVO.groupBuying_img}" height="200" width="200" />
				</a>
				<div class="pname">
					<c:out value="${mainVO.product_name}" />
					<br />
					<h6 class="lead">
						<fmt:formatNumber value="${mainVO.price}" pattern="###,###,###" />
					</h6>
	...
	<div id="stop" class="scrollTop">
		<a href="#top"> <i class="fas fa-angle-up fa-lg"></i>
		</a>
	</div>
