...
<body>
	...
	<div id="app">
		<div class="container">
				...
				<div class="column">
					<div class="dashboard">
						<div class="dashboard__content">
							<div class="header">
								<div>
									<p class="title is-5 is-pulled-left font-color-dark">신고한 목록
									</p>
			...
			<div class="row">
				<c:forEach items="${declareListData}" var="declareVO">
					<div class="col-lg-12 col-md-6 mb-4"> 
						<div class="card">
							<%-- <img class="card-img-top" src="img/${declareVO.img1}" alt="${declareVO.img1}"> --%>
							<div class="card-body">
								<h4 class="card-title">
									<c:out value="${declareVO.declare_pro_name}" /> 
								</h4>
								신고학번 <cite title="Source Title"><c:out value="${declareVO.reporter_stu_num}" /> </cite>
								<p class="lead">
									<c:out value="${declareVO.declare_category}" />
								</p>
							</div>
						</div>
					</div>
