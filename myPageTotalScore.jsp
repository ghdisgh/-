...
.rating {
	...
	.star input:checked ~ input:checked,
				...
				<div class="column">
					<div class="dashboard">
						<div class="dashboard__content">
							<div class="header">
								<div>
									<p class="title is-5 is-pulled-left font-color-dark">받은 평점 목록
									</p>
							...
							<div class="page main">
							<c:forEach items="${totalScoreData}" var="totalScoreVO">
							
									<div class="cardee ripple">
										
										
											<img src="img/${totalScoreVO.img1}" height="170" width="170" />
									
										<div class="pname">
											<c:out value="${totalScoreVO.name}" />
											<br />
							...
							<div class="star">
								...
								<c:choose>
								<c:when test='${totalScoreVO.score == 0}'>
									<h6>아직 평점이 없어요 :(</h6>
								</c:when>
								<c:when test='${totalScoreVO.score == 1}'>
									<div class="rating">
										<input id="rating-5" type="checkbox" name="rating" value="5"/>
										<label for="rating-5"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-4" type="checkbox" name="rating" value="4"/>
										<label for="rating-4"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-3" type="checkbox" name="rating" value="3"/>
										<label for="rating-3"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-2" type="checkbox" name="rating" value="2"/>
										<label for="rating-2"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-1" type="checkbox" name="rating" value="1" checked/>
										<label for="rating-1"><i class="fas fa-3x fa-star"></i></label>
									</div>
								</c:when>
								<c:when test='${totalScoreVO.score == 2}'>
									<div class="rating">
										<input id="rating-5" type="checkbox" name="rating" value="5"/>
										<label for="rating-5"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-4" type="checkbox" name="rating" value="4"/>
										...
										<input id="rating-3" type="checkbox" name="rating" value="3"/>
										<label for="rating-3"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-2" type="checkbox" name="rating" value="2" checked/>
										<label for="rating-2"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-1" type="checkbox" name="rating" value="1"/>
										<label for="rating-1"><i class="fas fa-3x fa-star"></i></label>
									</div>
								</c:when>
								<c:when test='${totalScoreVO.score == 3}'>
									<div class="rating">
										<input id="rating-5" type="checkbox" name="rating" value="5"/>
										<label for="rating-5"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-4" type="checkbox" name="rating" value="4"/>
										<label for="rating-4"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-3" type="checkbox" name="rating" value="3" checked/>
										<label for="rating-3"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-2" type="checkbox" name="rating" value="2"/>
										<label for="rating-2"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-1" type="checkbox" name="rating" value="1"/>
								...
								<c:when test='${totalScoreVO.score == 4}'>
									<div class="rating">
										<input id="rating-5" type="checkbox" name="rating" value="5"/>
										<label for="rating-5"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-4" type="checkbox" name="rating" value="4" checked/>
										<label for="rating-4"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-3" type="checkbox" name="rating" value="3"/>
										<label for="rating-3"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-2" type="checkbox" name="rating" value="2"/>
								...
								<c:when test='${totalScoreVO.score == 5}'>
									<div class="rating">
										<input id="rating-5" type="checkbox" name="rating" value="5" checked/>
										<label for="rating-5"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-4" type="checkbox" name="rating" value="4"/>
										<label for="rating-4"><i class="fas fa-3x fa-star"></i></label>
										<input id="rating-3" type="checkbox" name="rating" value="3"/>
								...
								<c:otherwise>
									<form method="post" action="Controller?cmd=myPageScoreAction&number=${totalScoreVO.num}&sellerId=${totalScoreVO.stu_seller_num}">
										<div class="rating">
											<input id="rating-5" type="checkbox" name="rating" value="5"/>
											<label for="rating-5"><i class="fas fa-3x fa-star"></i></label>
											<input id="rating-4" type="checkbox" name="rating" value="4"/>
