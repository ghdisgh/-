...
<body>
	<div class="container">
		<form method="post" action="Controller?cmd=productEnrollAction"
			...
			<div class="form-group">
				...
				<div class="controls">
					<textarea rows="5" cols="30" class="floatLabel" name="comment"
				...
				<div class="custom-file" style="margin-bottom: 20px">
					<input type="file" class="custom-file-input" id="inputGroupFile01"
						name="img1" aria-describedby="inputGroupFileAddon01"> <label
						class="custom-file-label" for="inputGroupFile01"></label>
				</div>
				<div class="custom-file" style="margin-bottom: 20px">
					<input type="file" class="custom-file-input" id="inputGroupFile01"
						name="img2" aria-describedby="inputGroupFileAddon01"> <label
						class="custom-file-label" for="inputGroupFile01"></label>
				</div>
				<div class="custom-file" style="margin-bottom: 20px">
					<input type="file" class="custom-file-input" id="inputGroupFile01"
						name="img3" aria-describedby="inputGroupFileAddon01"> <label
						class="custom-file-label" for="inputGroupFile01"></label>
				</div>
				<div class="custom-file" style="margin-bottom: 20px">
					<input type="file" class="custom-file-input" id="inputGroupFile01"
						name="img4" aria-describedby="inputGroupFileAddon01"> <label
						class="custom-file-label" for="inputGroupFile01"></label>
				</div>
				<div class="custom-file" style="margin-bottom: 20px">
					<input type="file" class="custom-file-input" id="inputGroupFile01"
						name="img5" aria-describedby="inputGroupFileAddon01"> <label
						class="custom-file-label" for="inputGroupFile01"></label>
				</div>
				<div class="custom-file" style="margin-bottom: 20px">
					<input type="file" class="custom-file-input" id="inputGroupFile01"
						name="img6" aria-describedby="inputGroupFileAddon01"> <label
						class="custom-file-label" for="inputGroupFile01"></label>
				</div>
				<div class="custom-file" style="margin-bottom: 20px">
					<input type="file" class="custom-file-input" id="inputGroupFile01"
						name="img7" aria-describedby="inputGroupFileAddon01"> <label
						class="custom-file-label" for="inputGroupFile01"></label>
				</div>
				<div class="custom-file" style="margin-bottom: 20px">
					<input type="file" class="custom-file-input" id="inputGroupFile01"
						name="img8" aria-describedby="inputGroupFileAddon01"> <label
						class="custom-file-label" for="inputGroupFile01"></label>
				</div>
				<div class="custom-file" style="margin-bottom: 20px">
					<input type="file" class="custom-file-input" id="inputGroupFile01"
						name="img9" aria-describedby="inputGroupFileAddon01"> <label
						class="custom-file-label" for="inputGroupFile01"></label>
				</div>
				<div class="custom-file" style="margin-bottom: 20px">
					<input type="file" class="custom-file-input" id="inputGroupFile01"
						name="img10" aria-describedby="inputGroupFileAddon01"> <label
						class="custom-file-label" for="inputGroupFile01"></label>
				</div>
				<div class="controls">
					<input type="text" class="floatLabel" name="price"
						placeholder="등록 희망 가격" />
				</div>
				<div class="controls">
					<input type="text" class="floatLabel" name="kakao"
						placeholder="오픈카톡 주소" />
				</div>
				<h3 class="heading">
