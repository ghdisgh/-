	...
	<div class="container-fluid" id="main">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-md-9 col-lg-10 main">
				<c:forEach items="${touchData}" var="studentVO">
					<div class="row mb-3">
						<div class="col-xl-6 col-lg-6">
							<div class="card card-inverse card-success">
								<div class="card-block bg-success">
									...
									<h3 class="display-1">${studentVO.count1+studentVO.count2+studentVO.count3}개</h3>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-6">
							<div class="card card-inverse card-danger">
								<div class="card-block bg-danger">
									...
									<h3 class="display-1">
										<fmt:formatNumber value="${studentVO.sum1+studentVO.sum2+studentVO.sum3}" pattern="###,###,###" /> 원
									</h3>
								</div>
							</div>
						</div>
						...
						<div>
							<table>
							  ...
							  <c:forEach items="${touchData}" var="studentVO">
							    <tr>
							      <td>2019</td>
							      <td>${studentVO.count3}개</td>
							      <td><fmt:formatNumber value="${studentVO.sum3}" pattern="###,###,###" />원</td>
							    </tr>
							  </c:forEach>
							  <c:forEach items="${touchData}" var="studentVO">
							    <tr>
							      <td>2018</td>
							      <td>${studentVO.count2}개</td>
							      <td><fmt:formatNumber value="${studentVO.sum2}" pattern="###,###,###" />원</td>
							    </tr>
							  </c:forEach>
							  <c:forEach items="${touchData}" var="studentVO">
							    <tr>
							      <td>2017</td>
							      <td>${studentVO.count1}개</td>
							      <td><fmt:formatNumber value="${studentVO.sum1}" pattern="###,###,###" />원</td>
							    </tr>
							  </c:forEach>
							  </tbody>
							</table>
