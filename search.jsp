...
<body>
	<div>
		<a href="Controller?cmd=mainAction"><i
					...
					<form id="join" name="join" onsubmit="return validate();"
						...
						<div class="container">
							...
							<div class="row">
								...
								</select> <select class="custom-select 2cha 11" id="a">
								...
								</select> <select class="custom-select 2cha 22" id="b">
								...
								</select> <select class="custom-select 2cha 33" id="c">
									<option>click</option>
								...
								</select> <select class="custom-select 2cha 44" id="d">
									<option>click</option>
								...
								</select> <select class="custom-select 2cha 55" id="e">
									<option>click</option>
									<option value="1501">지갑</option>
									<option value="1502">벨트</option>
									<option value="1503">기타</option>
								</select> <select class="custom-select 2cha 66" id="f">
									<option>click</option>
								...
								</select> <select class="custom-select 2cha 77" id="g">
									<option>click</option>
									<option value="1701">여성/남성시계</option>
									<option value="1702">시계소품</option>
									<option value="1703">기타</option>
								</select> <select class="custom-select 2cha 88" id="h">
									<option>click</option>
								...
								</select> <select class="custom-select 2cha 1616" id="p">
									<option>click</option>
								...
								</select> <select class="custom-select 2cha 1717" id="q">
									<option>click</option>
								...
								</select> <select class="custom-select 2cha 1818" id="r">
									<option>click</option>
									<option value="4301">음반</option>
									<option value="4302">DVD</option>
									<option value="4303">기타</option>
								</select> <select class="custom-select 2cha 1919" id="s">
									<option>click</option>
								...
								</select> <select class="custom-select 2cha 2020" id="t">
									<option>click</option>
      ...
      <use xmlns:xlink="http://www.w3.org/1999/xlink"
			...
			<input type="search" value="${word}" class="search-input" name="word"
				id="id">
				...
				<div class="page main">
					<c:forEach items="${search}" var="mainVO">
						<div class="cardee ripple">
							<c:choose>
								<c:when test="${mainVO.sell_condition == '거래 중'}">
									<span class="badg badge-ing"><c:out
											value="${mainVO.sell_condition}" /></span>
								</c:when>
							...
							<a
								href="Controller?cmd=productPurchaseAction&number=${mainVO.num}">
							...
							<div class="pname">
								...
								<br />
								<h6 class="lead">
									<fmt:formatNumber value="${mainVO.price}" pattern="###,###,###" />
								</h6>
							</div>
						</div>
					</c:forEach>
				...
				<div class="page main">
					<c:forEach items="${searchBazaarData}" var="mainVO">
						<div class="cardee ripple">
							...
							<a
								href="Controller?cmd=bazaarPurchaseAction&number=${mainVO.num}">
								<img src="img/${mainVO.img1}" />
							</a>
							<div class="pname">
								<c:out value="${mainVO.name}" />
					...
					<c:forEach items="${searchBookData}" var="bookVO">
						<div class="cardee ripple">
							...
							</a> <input type="hidden" name="num" value="${bookVO.book_num}">
							<div class="pname">
								<c:out value="${bookVO.book_name}" />
								<span class="badg badge-dark">대여/예약</span>
							</div>
						</div>
					</c:forEach>
					<div class="bott"></div>
