		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-md-9 col-lg-10 main">
				<c:forEach items="${studentBazaarData}" var="studentVO">
					<p class="lead hidden-xs-down">바자회 수익금 관리</p>
					<div class="row mb-3">
						<div class="col-xl-6 col-lg-6">
							<div class="card card-inverse card-danger">
								<div class="card-block bg-danger">
									...
									<h3 class="display-1">
										<fmt:formatNumber value="${studentVO.sum1+studentVO.sum2+studentVO.sum3+studentVO.sum4+studentVO.sum5+studentVO.sum6}" pattern="###,###,###" /> 원
									</h3>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-6">
							<div class="card card-inverse card-success">
								<div class="card-block bg-success">
									...
									<h4 class="text-uppercase">총 기부금</h4>
									<h2 class="display-1">132,600</h2>
								</div>
							</div>
						</div>
					</div>
				...
				<div>
					<table>
					  ...
					  <c:forEach items="${studentBazaarData}" var="studentVO">
					    <tr>
					      <td>6회</td>
					      <td><fmt:formatNumber value="${studentVO.sum6}" pattern="###,###,###" /> 원</td>
					    </tr>
					  </c:forEach>
					  <c:forEach items="${studentBazaarData}" var="studentVO">
					    <tr>
					      <td>5회</td>
					      <td><fmt:formatNumber value="${studentVO.sum5}" pattern="###,###,###" /> 원</td></td>
					    </tr>
					  </c:forEach>
					  <c:forEach items="${studentBazaarData}" var="studentVO">
					    <tr>
					      <td>4회</td>
					      <td><fmt:formatNumber value="${studentVO.sum4}" pattern="###,###,###" /> 원</td></td>
					    </tr>
					  </c:forEach>
					  <c:forEach items="${studentBazaarData}" var="studentVO">
					    <tr>
					      <td>3회</td>
					      <td><fmt:formatNumber value="${studentVO.sum3}" pattern="###,###,###" /> 원</td></td>
					    </tr>
					  </c:forEach>
					  <c:forEach items="${studentBazaarData}" var="studentVO">
					    <tr>
					      <td>2회</td>
					      <td><fmt:formatNumber value="${studentVO.sum2}" pattern="###,###,###" /> 원</td></td>
					    </tr>
					  </c:forEach>
					  <c:forEach items="${studentBazaarData}" var="studentVO">
					    <tr>
					      <td>1회</td>
					      <td><fmt:formatNumber value="${studentVO.sum1}" pattern="###,###,###" /> 원</td></td>
					    </tr>
					  </c:forEach>
					  </tbody>
					</table>
