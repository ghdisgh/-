							...
							<div class="card mb-4">
								...
								<div class="card-block">
									<h4 class="card-title">
										...
										<c:choose>
											...
											<c:when test="${studentVO.book_condition == 1}">
												<c:choose>
													<c:when test="${today >= studentVO.return_date}">
									...
									<c:choose>
										...
										<c:otherwise>
											<a href="Controller?cmd=bookReturnAction&number=${studentVO.reservation_num}&number2=${studentVO.book_num}&condition=${studentVO.book_enroll_condition}">
