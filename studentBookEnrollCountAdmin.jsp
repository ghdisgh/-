	...
	<div class="container-fluid" id="main">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-md-9 col-lg-10 main">
				<c:forEach items="${bookEnrollInfoCalData}" var="studentVO">
					<p class="lead hidden-xs-down">재고 관리</p>
					<div class="row mb-3">
						...
						<div class="col-xl-6 col-lg-6">
							<div class="card card-inverse card-danger">
								<div class="card-block bg-danger">
									...
									<h4 class="text-uppercase">총 훼손책수</h4>
									<h2 class="display-1">
										${studentVO.allDamage}
									</h2>
								</div>
				...
				<div class="row placeholders mb-3">
					<c:forEach items="${bookEnrollInfoData}" var="studentVO">
								...
								<div class="card-block">
									<h4 class="card-title">
										...
										<c:choose>
											...
											<c:when test="${studentVO.book_enroll_condition == 4}">
												<span class="badge badge-info">연체 중</span>
											</c:when>
											<c:otherwise>
									...
									<div>
										<a href="Controller?cmd=studentCouncilDeleteAction&number=${studentVO.book_num}&info_num=0"
